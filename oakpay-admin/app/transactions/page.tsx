      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#6b7280]">
            Monitor OakPay P2P transactions, wallet movements and
        ...
        <section className="overflow-hidden rounded-2xl border border-[#e3e8e5] bg-white shadow-sm">
          ...
          <div className="flex min-h-[300px] flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mt-2 max-w-md text-sm leading-6 text-[#6b7280]">
              The transaction monitoring workspace is ready for
              connection to the OakPay transaction and P2P APIs.
            </p>
          </div>
        </section>
      </div>
