...
function Login() {
    ...
    async function accept(t) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["session"].set(t);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].summary(t.accessToken);
            router.replace('/');
        } catch  {
    ...
    async function submit(e) {
        ...
        try {
            if (challenge) {
                await accept(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].verify2fa(challenge, code));
                return;
            }
            const t = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].login(email.trim().toLowerCase(), password);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dfc13f24._.js.map