...
function Login() {
    ...
    async function acceptToken(token) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["session"].set(token);
        /*
    ...
    async function submit(event) {
        ...
        setBusy(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].login(email.trim(), password);
    ...
    async function verifyTwoFactor(event) {
        ...
        setBusy(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminApi"].verify2fa(challenge, code);
            await acceptToken(response);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2de13252._.js.map