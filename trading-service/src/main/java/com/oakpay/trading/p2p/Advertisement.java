...
public class Advertisement {
    ...
    @Column(nullable = false, precision = 38, scale = 18, updatable = false) private BigDecimal price;
    @Column(name = "total_quantity", nullable = false, precision = 38, scale = 18) private BigDecimal totalQuantity;
    @Column(name = "available_quantity", nullable = false, precision = 38, scale = 18) private BigDecimal availableQuantity;
    @Column(name = "min_quantity", nullable = false, precision = 38, scale = 18, updatable = false) private BigDecimal minQuantity;
    @Column(name = "max_quantity", nullable = false, precision = 38, scale = 18, updatable = false) private BigDecimal maxQuantity;
