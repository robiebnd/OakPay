...
public class BitGoWebhookController {
    ...
    public DepositDtos.DepositResponse transferWebhook(
            @PathVariable String coin,
            @RequestHeader("X-Signature-SHA256") String signature,
        ...
        try {
            ...
            throw new ResponseStatusException(
                    HttpStatus.BAD_REQUEST, "Unable to read BitGo webhook payload", e);
        }
    }
}
