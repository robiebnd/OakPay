...
import { OakPayApiError, P2PPayment, P2PTrade, isAuthError, p2pApi } from '../../lib/api';
...
export default function OrdersScreen(){
 ...
 async function action(kind:'paid'|'verify'|'confirm'|'cancel'|'dispute'){
  ...
  try{
   ...
   if(kind==='paid'){
    ...
    await p2pApi.dispute(accessToken,selected.id);
   }else{
