  ...
  async function handleLogin() {
    ...
    try {
      ...
      if(result.requiresTwoFactor && result.challengeToken){
        router.replace({pathname:'/(auth)/verify-2fa',params:{challengeToken:result.challengeToken,email:email.trim().toLowerCase()}});
      }
    }
...
const styles = StyleSheet.create({
  keyboardView: { flex: 1, backgroundColor: '#F7F8F9' }, scrollContent: { flexGrow: 1, justifyContent: 'center' }, container: { width: '100%', paddingHorizontal: 40, paddingTop: 52, paddingBottom: 36 }, brand: { marginBottom: 38, alignItems: 'center' }, logo: { width: 285, height: 96 }, subtitle: { marginTop: 2, fontFamily: 'Inter_400Regular', fontSize: 15, color: '#6F747B' }, form: { width: '100%' }, success: { marginBottom: 14, color: '#183F2C', fontFamily: 'Inter_600SemiBold', fontSize: 14, lineHeight: 20, textAlign: 'center' }, title: { fontFamily: 'Inter_700Bold', fontSize: 30, color: '#111916', letterSpacing: -0.6, textAlign: 'center' }, description: { marginTop: 10, marginBottom: 24, fontFamily: 'Inter_400Regular', fontSize: 16, color: '#6F747B', lineHeight: 23, textAlign: 'center' }, input: { height: 58, backgroundColor: '#FFFCE0', color: '#111916', borderRadius: 18, paddingHorizontal: 18, marginBottom: 14, borderWidth: 1, borderColor: '#EEE9AE', fontFamily: 'Inter_400Regular', fontSize: 16 }, forgot: { alignSelf: 'flex-end', marginTop: -4, marginBottom: 8, paddingVertical: 4 }, forgotText: { color: '#123B2A', fontFamily: 'Inter_700Bold', fontSize: 14 }, error: { color: '#B42318', marginBottom: 12, fontFamily: 'Inter_600SemiBold', lineHeight: 20, textAlign: 'center' }, button: { height: 58, borderRadius: 29, backgroundColor: '#123B2A', alignItems: 'center', justifyContent: 'center', marginTop: 8 }, buttonDisabled: { opacity: 0.65 }, buttonText: { color: '#FFFFFF', fontFamily: 'Inter_700Bold', fontSize: 16 }, register: { textAlign: 'center', marginTop: 22, color: '#6F747B', fontFamily: 'Inter_400Regular', fontSize: 15 }, registerAccent: { color: '#123B2A', fontFamily: 'Inter_700Bold' },
});
