      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <View style={styles.container}>
          ...
          <View style={styles.row}>
            <TextInput value={firstName} onChangeText={setFirstName} placeholder="First name" placeholderTextColor="#70757D" style={[styles.input, styles.half]} returnKeyType="next" />
            <TextInput value={lastName} onChangeText={setLastName} placeholder="Last name" placeholderTextColor="#70757D" style={[styles.input, styles.half]} returnKeyType="next" />
          </View>
          ...
          <TextInput value={password} onChangeText={setPassword} placeholder="Password" placeholderTextColor="#70757D" secureTextEntry returnKeyType="done" onSubmitEditing={handleRegister} style={styles.input} />
...
const styles = StyleSheet.create({
  ...
  container: { width: '100%', paddingHorizontal: 40, paddingTop: 52, paddingBottom: 40 },
  ...
  half: { flex: 1 },
  hint: { color: '#8A918D', fontFamily: 'Inter_400Regular', fontSize: 12, marginTop: -4, marginBottom: 10 },
